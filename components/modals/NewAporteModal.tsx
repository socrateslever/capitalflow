    ...
    <div className="fixed inset-0 z-[9999] flex items-center justify-center">
      ...
      <div className="relative w-[92vw] max-w-xl max-h-[90vh] flex flex-col rounded-2xl border border-slate-800 bg-slate-950 shadow-2xl overflow-hidden">
        <div className="flex items-center justify-between p-5 border-b border-slate-800 shrink-0">
          ...
          <button
            className="p-2 rounded-full bg-slate-900 border border-slate-800 hover:bg-slate-800 self-start"
        ...
        <div className="p-5 overflow-y-auto custom-scrollbar space-y-4">
          {/* Valor */}
          <div className="bg-slate-900 border border-slate-800 rounded-full p-3">
            ...
            <input
              ...
              className="w-full bg-slate-950 border border-slate-800 rounded-full px-3 py-2 text-white font-bold outline-none focus:border-blue-600"
            />
          ...
          <div className="bg-slate-900 border border-slate-800 rounded-full p-3">
            ...
            <div className="relative group">
                <select
                  ...
                  className="w-full appearance-none bg-slate-950 border border-slate-800 rounded-full px-3 py-2 pr-10 text-white font-bold outline-none focus:border-blue-600 cursor-pointer"
                >
          ...
          {err ? (
            <div className="bg-rose-500/10 border border-rose-500/20 rounded-full p-3">
        ...
        <div className="p-5 border-t border-slate-800 flex gap-2 shrink-0 bg-slate-950">
          <button
            onClick={onClose}
            disabled={loading}
            className="flex-1 py-3 rounded-full bg-slate-900 border border-slate-800 text-slate-200 font-black text-xs uppercase tracking-widest hover:bg-slate-800 disabled:opacity-60"
          >
            Cancelar
          </button>
          <button
            ...
            disabled={loading}
            className="flex-1 py-3 rounded-full bg-blue-600 text-white font-black text-xs uppercase tracking-widest hover:bg-blue-500 disabled:opacity-60"
          >
